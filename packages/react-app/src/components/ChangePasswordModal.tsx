...
import { IMap, IStrength, IErrorResponse } from "../utils/types";
import { INIT_STRENGTH } from "../utils/constants";
...
const ChangePasswordModal: React.FC<ChangePasswordModalProps> = (props) => {
  ...
  const [strength, setStrength] = useState<IStrength>(INIT_STRENGTH);
  ...
  const handleSubmit = async () => {
    ...
    // change password if password is valid
